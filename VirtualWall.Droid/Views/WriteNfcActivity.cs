...
namespace VirtualWall.Droid.Views 
{
    ...
    public class WriteNfcActivity : Activity
    {
        ...
        protected override void OnCreate(Bundle bundle) 
        {
            ...
            var discovery = new IntentFilter(NfcAdapter.ActionTagDiscovered);
            ...
            if (NfcAdapter.ActionTagDiscovered.Equals(intent.Action)) {
                ...
                if (SupportedTechs(detectedTag.GetTechList())) {
                    ...
                    if (WritableTag(detectedTag)) {
                        //writeTag here
                        WriteResponse wr = WriteTag(GetTagAsNdef(_nfcStringData), detectedTag);
